  ...
  var plugin = function plugin(_) {
    ...
    addFilter('CREATE_VIEW', function(viewAPI) {
      ...
      var openEditor = function openEditor(_ref4) {
        ...
        editor.open(file, imageParameters, item);
      };
      ...
      var didLoadItem = function didLoadItem(_ref6) {
        ...
        root.ref.handleMoveUp = function (e) {
            e.stopPropagation();
            root.dispatch('MOVEUP_ITEM', { id: id });
        };
        root.ref.handleMoveDowm = function (e) {
            e.stopPropagation();
            root.dispatch('MOVEDOWN_ITEM', { id: id });
        };
      ...
      view.registerDestroyer(function(_ref7) {
        ...
        if (root.ref.buttonMoveUpItem) {
            root.ref.buttonMoveUpItem.off('click', root.ref.handleMoveUp);
        }
        if (root.ref.buttonMoveDownItem) {
            root.ref.buttonMoveDownItem.off('click', root.ref.handleMoveDown);
        }
      });
